    ...
    <div class="auth-container">
      <div class="auth-card">
        ...
        <form class="auth-form" @submit.prevent="handleResetPassword">
          ...
          <button type="submit" class="btn btn-primary btn-block" :disabled="isLoading || isSuccess">
        ...
        <div class="auth-footer">
          <p><a href="#" @click.prevent="goToLogin">{{ t('auth.backToLogin') }}</a></p>
        </div>
      </div>
    </div>
  </div>
...
useHead({
  title: t('auth.resetPasswordTitle') + ' - MedSkills'
})
</script>
